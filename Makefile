...
OFILES = main.o spaceship.o enemy1.o enemy2.o start.o gameover.o mylib.o levels.o text.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = spaceship.h enemy1.h enemy2.h start.h gameover.h mylib.h levels.h text.h
